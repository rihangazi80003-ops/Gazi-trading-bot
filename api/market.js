export default async function handler(req, res) {
  ...
  try {
    ...
    /*
    ============================================================
      FINORIX MARKET API v3 (2 CANDLES ADVANCE)

      Requirement:
        Finorix = 2 candles ahead of Quotex.
    ============================================================
    */
    ...
    /*
      Exact requirement: exactly 2 candles ahead to match Quotex.
    */
    const DISPLAY_ADVANCE_CANDLES = 2;
