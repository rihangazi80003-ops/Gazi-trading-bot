export default async function handler(req, res) {
  ...
  try {
    ...
    /*
    ============================================================
      FINORIX MARKET API v3 (UPDATED)

      Requirement:
        Finorix = 3 candles ahead to perfectly match Quotex.
    ============================================================
    */
    ...
    /*
      Exact requirement: 3 candles ahead to match Quotex.
    */
    const DISPLAY_ADVANCE_CANDLES = 3;
